...
class TestAStar(TestCase):
    ...
    def setup(self):
        ...
        self.occ1 = generate_sample_grid2(self.map_size, self.map_resolution, plot=False)
        self.occ2 = generate_sample_grid4(self.map_size, self.map_resolution, plot=False)
